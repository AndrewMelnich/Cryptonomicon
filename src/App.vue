...
export default {
  ...
  methods: {
    add() {
      ...
      setInterval(async () => {
        const f = await fetch(`https://min-api.cryptocompare.com/data/price?fsym=${currentTicker.name}&tsyms=USD&api_key=5fda0469860ca820ef204d23a2a546518529187342d4791ae4bc24862d7d4072`);
