...
export default {
  ...
  methods: {
    closeGraph() {
      this.$emit("closeGraph", this.selectedTicker);
    },

    getGraphWidth() {
      const elementWidth = this.$refs.graph.clientWidth;
      this.graphWidth = elementWidth;
    },
    ...
    calculateMaxGraphElements() {
      ...
      //   return;
      // }
      this.$emit("windowWith", this.graphWidth);
    },
  },
